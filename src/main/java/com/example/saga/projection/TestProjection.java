...
public class TestProjection {
    ...
    public void on(TestEntityUpdatedEvent event) {
       ...
       Optional<TestEntity> testEntityOpt= testRepository.findById(event.id);
    ...
    @EventHandler
    public void on(TestEntityCompensatedEvent event) {
        System.out.println("Test entity cancel edildi"+event.id);
        Optional<TestEntity> testEntityOpt= testRepository.findById(event.id);
        if(testEntityOpt.isPresent())
        {
